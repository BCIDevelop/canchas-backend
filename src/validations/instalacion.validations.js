      ...
      [Segments.BODY]: Joi.object().keys({
        ...
        id_admin: Joi.number()
          ...
          .messages({
            ...
            'number.integer': 'El ID del administrador debe ser un número entero.',
            'number.positive': 'El ID del administrador debe ser un número positivo.',
      ...
      [Segments.PARAMS]: Joi.object().keys({
        id: Joi.number()
          ...
          .messages({
            ...
            'number.integer': 'El ID de la instalación debe ser un número entero.',
            'number.positive': 'El ID de la instalación debe ser un número positivo.',
      ...
      [Segments.BODY]: Joi.object().keys({
        id: Joi.number()
          ...
          .messages({
            ...
            'number.positive': 'El ID de administrador debe ser un número positivo.',
