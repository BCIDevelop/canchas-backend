      ...
      [Segments.BODY]: Joi.object().keys({
        ...
        celphone: Joi.string()
          ...
          .messages({
            ...
            'string.length': 'El número de celular debe tener exactamente 9 dígitos.',
            'string.pattern.base': 'El número de celular solo debe contener números.',
        ...
        termsAccepted: Joi.boolean()
          ...
          .messages({
            ...
            'boolean.base': 'El valor de términos y condiciones debe ser verdadero o falso.'
          })
      }),
    });
  }
