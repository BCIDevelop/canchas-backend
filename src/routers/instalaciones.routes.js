...
class InstalacionRouter {
  ...
  constructor() {
    this.router = Router();
    this.uploader_create = new ImageUploader(process.env.FOTOS_INSTALACIONES, 5, 200, true);
    this.uploader_update = new ImageUploader(process.env.FOTOS_INSTALACIONES, 5, 200);
  }
  ...
  init() {
    return this.router
      ...
      .patch('/admin/', Validations.changeAdminInstalacion(), this.changeAdminInstalacion)
  }
