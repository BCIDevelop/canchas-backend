    ...
    if (err instanceof multer.MulterError || err.code === 'INVALID_FORMAT') {
      ...
      switch (err.code) {
        ...
        case 'LIMIT_FILE_SIZE':
          errores.push(`El archivo excede el tamaño permitido. Máximo permitido: ${this.maxSize} MB.`);
          break;
  ...
  cleanupFiles = (req) => {
    ...
    req.files.forEach(file => {
      ...
      try {
        ...
        else console.warn(`Advertencia: Archivo no encontrado, no se pudo eliminar: ${file.path}`);
